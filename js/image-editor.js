        ...
        dom['layers-list'].innerHTML = state.layers.slice().reverse().map(l => {
                ...
                return `
                    <div class="object-item ${isSelected ? 'selected' : ''}" onclick="event.stopPropagation(); selectObject('${l.id}','${o.id}')">
                        ...
                        <div style="display:flex; gap:4px;">
                            <button class="${o.visible ? 'text-gray-500 hover:text-white' : 'text-gray-700'}" onclick="event.stopPropagation(); toggleObjectVisibility('${l.id}', '${o.id}')" title="Toggle Visibility">${o.visible ? '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1.5 12s4.5-7.5 10.5-7.5S22.5 12 22.5 12 18 19.5 12 19.5 1.5 12 1.5 12z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15.75A3.75 3.75 0 1 0 12 8.25a3.75 3.75 0 0 0 0 7.5z"/></svg>' : '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3l18 18"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.58 10.58A3.75 3.75 0 0 0 12 15.75a3.75 3.75 0 0 0 3.42-2.17"/></svg>'}</button>
                            <button class="${o.locked ? 'text-red-400 hover:text-white' : 'text-gray-700'}" onclick="event.stopPropagation(); toggleObjectLock('${l.id}', '${o.id}')" title="Toggle Lock">${o.locked ? '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.5 10.5V8.25a4.5 4.5 0 0 1 9 0v2.25"/><rect x="5" y="10.5" width="14" height="10" rx="2" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg>' : '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.5 10.5V8.25a4.5 4.5 0 1 1 9 0"/><rect x="5" y="10.5" width="14" height="10" rx="2" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg>'}</button>
                        </div>
                    </div>
                `;
            }).join('');
            ...
            <div class="layer-group ${isActive ? 'active-layer' : ''}" style="${isActive ? 'border-color:var(--accent-primary); border-width:1px;' : ''}">
                <div class="layer-header ${isActive ? 'active' : ''}" onclick="selectLayer('${l.id}')">
                    <button style="margin-right:8px;" class="${l.visible ? 'text-[var(--accent-primary)]' : 'text-gray-500'}" onclick="event.stopPropagation(); toggleLayerVisibility('${l.id}')">${l.visible ? '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1.5 12s4.5-7.5 10.5-7.5S22.5 12 22.5 12 18 19.5 12 19.5 1.5 12 1.5 12z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15.75A3.75 3.75 0 1 0 12 8.25a3.75 3.75 0 0 0 0 7.5z"/></svg>' : '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3l18 18"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.58 10.58A3.75 3.75 0 0 0 12 15.75a3.75 3.75 0 0 0 3.42-2.17"/></svg>'}</button>
                    <span class="flex-1 truncate" title="${l.name}">${l.name}</span>
                    <button style="margin-left:8px;" class="${l.locked ? 'text-red-400' : 'text-gray-600'}" onclick="event.stopPropagation(); toggleLayerLock('${l.id}')">${l.locked ? '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.5 10.5V8.25a4.5 4.5 0 0 1 9 0v2.25"/><rect x="5" y="10.5" width="14" height="10" rx="2" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg>' : '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.5 10.5V8.25a4.5 4.5 0 1 1 9 0"/><rect x="5" y="10.5" width="14" height="10" rx="2" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg>'}</button>
